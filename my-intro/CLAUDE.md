...
`node` happens to be installed on this machine. Outside `day5/news`, `day6/dust`, `day6/shopping/server`, `day7/restaurant`, `day4`, and `day11` (which depend on it directly), its only use is ad-hoc syntax checking of inline scripts.
